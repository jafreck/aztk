...
def setup_parser(parser: argparse.ArgumentParser):
    ...
    parser.add_argument('--brief', '-b', required=False, action='store_true',
                        help='Only gets a small subset of key logs')
...
def execute(args: typing.NamedTuple):
    ...
    with utils.Spinner():
        spark_client.run_cluster_diagnostics(cluster_id=args.cluster_id, output_directory=args.output, brief=args.brief)
