...
def setup_parser(parser: argparse.ArgumentParser):
    ...
    submit_parser = subparsers.add_parser(
        "submit", help="Submit a new gatk job to a cluster")
    run_parser = subparsers.add_parser(
        ClusterAction.run, help="Run a command on all nodes in your gatk cluster")
    copy_parser = subparsers.add_parser(
        ClusterAction.copy, help="Copy files to all nodes in your gatk cluster")
