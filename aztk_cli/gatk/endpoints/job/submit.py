...
def setup_parser(parser: argparse.ArgumentParser):
    parser.add_argument('--id',
                        dest='job_id',
                        required=False,
                        help='The unique id of your gatk Job. Defaults to the id value in .aztk/job.yaml')
...
def execute(args: typing.NamedTuple):
    ...
    if job_conf.gatk_env_sh:
        spark_configuration.gatk_env_sh = job_conf.gatk_env_sh
    ...
    gatk_client.submit_job(job_configuration)
