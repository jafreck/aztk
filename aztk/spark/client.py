...
class Client(BaseClient):
    ...
    def run_cluster_diagnostics(self, cluster_id, output_directory=None, brief=False):
        try:
            output = cluster_diagnostic_helper.run(self, cluster_id, output_directory, brief)
            return output
        except batch_error.BatchErrorException as e:
            raise error.AztkError(helpers.format_batch_exception(e))
