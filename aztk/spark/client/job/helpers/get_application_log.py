...
def _get_application_log(spark_job_operations, job_id, application_name):
    ...
    try:
        task = spark_job_operations.batch_client.task.get(job_id=recent_run_job.id, task_id=application_name)
...
def get_job_application_log(spark_job_operations, job_id, application_name):
    try:
        return _get_application_log(spark_job_operations, job_id, application_name)
