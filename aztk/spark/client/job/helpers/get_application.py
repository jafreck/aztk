...
def _get_application(spark_client, job_id, application_name):
    # info about the app
...
def get_application(spark_job_client, job_id, application_name):
    try:
        return models.Application(_get_application(spark_job_client, job_id, application_name))
