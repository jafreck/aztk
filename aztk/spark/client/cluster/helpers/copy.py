...
def cluster_copy(spark_cluster_operations, cluster_id: str, source_path: str, destination_path: str, host: bool = False, internal: bool = False, timeout: int = None):
    try:
        ...
        return super(type(spark_cluster_operations), spark_cluster_operations).copy(cluster_id, source_path, destination_path=destination_path, container_name=container_name, get=False, internal=internal, timeout=timeout)
