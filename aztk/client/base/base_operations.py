...
class BaseOperations:
    ...
    #TODO: rename pool to cluster or make private
    ...
    #TODO: rename pool to cluster or make private, get rid of nodes parameter
    def create_user_on_pool(self, id, nodes, username, ssh_pub_key=None, password=None):
    ...
    #TODO: rename pool to cluster or make private
    def generate_user_on_pool(self, id, nodes):
        ...
        Returns:
            tuple: A tuple of the form (username (:obj:`str`), ssh_key) where ssh_key is a Cryptodome.RSA key.
        """
        return generate_user_on_pool.generate_user_on_pool(self, id, nodes)
    ...
    #TODO: rename pool to cluster or make private
    def delete_user_on_pool(self, username, id, nodes):
        ...
        Returns:
            None
        """
        return delete_user_on_pool.delete_user_on_pool(self, username, id, nodes)
