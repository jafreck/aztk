...
def setup_ssh_keys():
    pub_key_path_src = os.path.join(config.aztk_working_dir, "id_rsa.pub")
    priv_key_path_src = os.path.join(config.aztk_working_dir, "id_rsa")
...
def copy_spark_env():
    spark_env_path_src = os.path.join(config.aztk_working_dir, "conf/spark-env.sh")
...
def copy_spark_defaults():
    spark_default_path_src = os.path.join(config.aztk_working_dir, "conf/spark-defaults.conf")
...
def copy_core_site():
    spark_core_site_src = os.path.join(config.aztk_working_dir, "conf/core-site.xml")
...
def copy_jars():
    ...
    spark_default_path_src = os.path.join(config.aztk_working_dir, "jars")
