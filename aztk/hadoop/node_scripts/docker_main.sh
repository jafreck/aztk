...
set -e
source ~/.bashrc
echo "Initializing hadoop container"
...
# add all files from 'jupyter-samples' to container folder '/pyhadoop/samples'
...
$AZTK_WORKING_DIR/.aztk-env/.venv/bin/python $(dirname $0)/main.py setup-hadoop-container
