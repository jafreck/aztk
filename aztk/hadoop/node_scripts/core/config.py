...
# hadoop_web_ui_port = os.environ["hadoop_WEB_UI_PORT"]
# hadoop_worker_ui_port = os.environ["hadoop_WORKER_UI_PORT"]
# hadoop_job_ui_port = os.environ["hadoop_JOB_UI_PORT"]
